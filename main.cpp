...
static void display(void)
{
  ...
  // glRotated(a,0,1,0);
    ...
    //Face
    glColor3d(1,0.87,0.74);
    glPushMatrix();
        glTranslated(-1.5,0.5,1);
        glScaled(0.9,1.7,0.3);
        glutSolidSphere(3,slices,stacks);
    glPopMatrix();
    glPushMatrix();
        glTranslated(1.5,0.5,1);
    ...
    glColor3d(0,0,0);
    glPushMatrix();
        glTranslated(-1.4,pos,2.5);
        glScaled(0.5,1.3,0.1);
    ...
    glPushMatrix();
        ...
        glRotated(-50,1,0,0);
        glScaled(1.7,0.9,0.5);
        glutSolidTorus(0.5,1,slices,stacks);
    glPopMatrix();
//glPopMatrix();
    glutSwapBuffers();
}
